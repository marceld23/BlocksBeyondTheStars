...
namespace BlocksBeyondTheStars.Client
{
    ...
    /// <c>BlocksBeyondTheStars/Post*</c> shaders. Preset-gated: off on Potato/Low, bloom+tonemap on Medium, +AO on
    ...
    public sealed class PostFx : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            _bloom = Make("BlocksBeyondTheStars/PostBloom");
            _composite = Make("BlocksBeyondTheStars/PostComposite");
            _ao = Make("BlocksBeyondTheStars/PostAO");
