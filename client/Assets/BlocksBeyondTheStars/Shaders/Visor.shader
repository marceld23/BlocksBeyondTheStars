...
// a faux-fresnel rim glow, a cheap additive glow, and a faint world reflection.
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                float3 glow = SAMPLE_TEXTURE2D(_HudTex, sampler_HudTex, hudUv + float2(o.x, 0)).rgb
                            + SAMPLE_TEXTURE2D(_HudTex, sampler_HudTex, hudUv - float2(o.x, 0)).rgb
                            + SAMPLE_TEXTURE2D(_HudTex, sampler_HudTex, hudUv + float2(0, o.y)).rgb
                            + SAMPLE_TEXTURE2D(_HudTex, sampler_HudTex, hudUv - float2(0, o.y)).rgb;
                glow *= 0.25;
