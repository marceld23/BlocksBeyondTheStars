...
`item_shape_tool`/`item_shape_stencil`, the boat `item_boat` (#1215), the farmed cereal `item_grain` (#1204), the campfire meals `item_hearty_stew`/`item_algae_soup`/`item_mushroom_skewer` (#1203), and the sandworm thumper `item_thumper` (#2002)) are
