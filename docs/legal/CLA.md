...
**Project:** Blocks Beyond the Stars
**Project owner ("We"/"Us"):** JuMaVe Games — Justus Dütscher & Marcel Dütscher
...
> Agreement (HA-CLA-I), version 1.0** (<http://harmonyagreements.org>), with the
...
contributors to Us. By signing it (via the CLAassistant bot on your first pull
request), You accept and agree to the following terms for Your present and future
Contributions submitted to Us. Except for the license granted herein, You reserve
all right, title and interest in and to Your Contributions.

## 1. Definitions

- **"You"/"Your"** means the individual who Submits a Contribution to Us.
...
license in the Contribution, with the right to sublicense such rights through
multiple tiers of sublicensees, to reproduce, modify, display, perform and
distribute the Contribution as part of the Material, **and to license or
re-license the Contribution (in whole or in part, including in combination with
the Material) under terms of Our choosing — including the GNU AGPL-3.0-or-later
for the public version and a separate proprietary/commercial license for closed
platforms (e.g. game-console networks and storefronts).**
...
As a condition of and in consideration for the grant above, **We will license the
Material — including Your Contribution — to the public under the GNU AGPL-3.0-or-later
(or any later version of that license), and We guarantee the public GitHub version
...
- Each Contribution is Your original creation, or You have the necessary rights to
...
Unless required by applicable law or agreed to in writing, the Contribution is
...
*Signing happens automatically: open a pull request and the CLAassistant bot will
ask you to accept this Agreement with a single click via your GitHub account.*
