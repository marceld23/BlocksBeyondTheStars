...
*   **Play in your language:** the whole game is localized in **English, German, French, Spanish and Dutch** — and community translations are welcome (Italian is underway; see [docs/developer/TRANSLATION_GUIDE.md](docs/developer/TRANSLATION_GUIDE.md)).
...
> Spanish and Dutch are complete; Italian is a community translation in progress**
...
French, Spanish and Dutch**. Self-hostable dedicated server. **Native Windows and Linux**
