...
- **Ahmed Mohamed Abdelhady Kamel** ([@ahmdkaml](https://github.com/ahmdkaml)) — server test coverage: an ongoing series of unit tests for core server types and contracts — from the world math primitives through presets, localization, mission validation and deterministic randomness to the noise generators ([#571](https://github.com/marceld23/BlocksBeyondTheStars/issues/571), PRs [#917](https://github.com/marceld23/BlocksBeyondTheStars/pull/917)–[#947](https://github.com/marceld23/BlocksBeyondTheStars/pull/947))
- **Tom Erland Husby** ([@Tombonator3000](https://github.com/Tombonator3000)) — story engine: finale and one-shot insight lines became pack-owned (`finaleRevealTextKey`, `insightUnlockBeatCount`, …) with full-surface pack validation in `merge_story.py`, so a second campaign speaks its own words — upstreamed from his [Voidcraft](https://github.com/Tombonator3000/Voidcraft) fork ([#1085](https://github.com/marceld23/BlocksBeyondTheStars/issues/1085), [#1086](https://github.com/marceld23/BlocksBeyondTheStars/issues/1086))
