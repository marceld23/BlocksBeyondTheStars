...
ITEMS = [
    ...
    ("fruit_grape", "a small hanging cluster of round purple grapes with a short stem"),
    ("fruit_banana", "a single ripe yellow curved banana with a short brown stem"),
    ("toxic_fruit_round", "a single plump round apple-like fruit with a short stem and one small leaf"),
    ("toxic_fruit_long", "a single long slender smooth pod-like fruit with a short stem"),
    ("toxic_fruit_grape", "a small hanging cluster of round grapes with a short stem"),
    ("toxic_fruit_banana", "a single curved banana-shaped fruit with a short stem"),
    ...
    ("suit_liner_1", "a neatly folded padded thermal suit liner undergarment, grey fabric with orange quilted insulation stitching"),
    ("suit_liner_2", "a folded high-tech silver insulation suit liner with layered quilted padding and thin embedded heat pipes"),
    ("suit_liner_3", "a sleek compact suit climate-control module with glowing orange and cyan thermal regulator coils and small vents"),
    ...
    # #2058 Crystal Net (2026-09-27)
    ("crystal_conduit", "a sci-fi crystal conduit segment, translucent violet crystal rod in a dark metal frame with silver clamps"),
    ("crystal_switch", "a sci-fi wall switch device, dark metal plate with a chunky violet crystal lever and a green status light"),
    ("crystal_button", "a sci-fi push button device, dark metal plate with a large round orange crystal button"),
    ("step_plate", "a sci-fi floor pressure plate, brushed steel square with a violet crystal rim and corner rivets"),
    ("proximity_sensor", "a sci-fi motion sensor device, dark metal housing with a glowing cyan eye lens and antenna fins"),
    ("daylight_sensor", "a sci-fi daylight sensor device, dark metal frame around a pale yellow crystal solar cell with a sun emblem"),
    ("storage_sensor", "a sci-fi storage sensor device, dark metal box with a small crate icon screen and three level lights"),
    ("watcher", "a sci-fi watcher device, dark metal housing with one large violet crystal eye and a thin eyelid ring"),
    ("logic_block", "a sci-fi logic gate cube, dark metal with a glowing blue circuit-trace pattern and a gate symbol"),
    ("timer_block", "a sci-fi timer cube, dark metal with a glowing amber clock face and tick marks"),
    ("alarm_siren", "a sci-fi alarm siren device, dark metal base with a red warning lamp dome and a small horn"),
    ("chime", "a sci-fi doorbell chime, warm brass bell in a dark metal frame with a violet crystal striker"),
    ("horn", "a sci-fi signal horn, large brass horn bell on a dark metal box"),
    ("melody_block", "a sci-fi melody cube, dark metal with glowing pastel crystal keys like a tiny xylophone"),
    ("announcer", "a sci-fi announcer speaker box, dark metal with a violet crystal grille and a small radio dish"),
    ("fabricator", "a sci-fi automatic workbench machine with a small robotic arm over a work surface and a violet crystal window"),
    ("caller", "a sci-fi animal caller post with a brass whistle and a violet crystal tuning fork"),
    ("clone_tank", "a sci-fi cloning tank, dark metal frame around a glass cylinder of glowing teal fluid with bubbles"),
    ("auto_drill_1", "a sci-fi auto-drill mk1, compact dark metal rig with a single steel drill bit pointing down and one violet light"),
    ("auto_drill_2", "a sci-fi auto-drill mk2, heavier dark metal rig with twin steel drill bits, carbide edges and two violet lights"),
